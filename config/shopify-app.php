...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,read_orders,write_orders,write_order_edits,read_customers,read_inventory,read_fulfillments, write_themes, read_themes, write_products, read_products'),
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            ...
            'address' => env('APP_URL').'/webhook/refunds-create'
        ],
        [
    ...
    /*'webhooks' => (strpos(config('app.url'), '.localhost') === false) ? [
        [
            'topic' => 'app/uninstalled',
            'address' => env('APP_URL').'/webhook/app-uninstalled'
        ]
